...
> En (Poy & Gonzales-Aguilar, 2014) se presentó un estudio y análisis de los MOOC (Cursos online abiertos y masivos), una de las herramientas que ha surgido de la combinación de e-learning y modelos de redes sociales, la cual se ha integrado en muchos programas educativos transformando las organizaciones e-learning a nivel mundial. A partir de los estudios previos, se identificaron en el análisis cuatro factores críticos que son (1)el diseño de software educativo, (2)las tasas de abandono, (3)el alcance de la universalización, y (4)la estrategia de negocio subyacente a esta oferta educativa.
...
_Desfasado en el tiempo. 27/03/2016_

> Se desarrollaron un contjunto de componentes necesarios para el correcto funcionamiento de este sistema, entre los cuáles están: el desarrollo del servició Web encargado de realizar las recomendaciones mediante el filtrado colaborativo con la API de Apache Mahout, los componentes de análisis sentimental en donde se usa la API de SkyBiometry para la detección del sentimiento del estudiante, el analizador de peticiones que sirve como puerta de enlace a la petición que realiza el usuario al momento de ceder o no las funcionalidades de su cámara Web, así como también el uso de diversas tecnologías para complementar el sistema como el uso de CSS3 para los estilos de la página, JQuery para el uso de la cámara Web y las fotografías automáticas del estudiante, Ajax para la funcionalidad de almacenar la fotografía automáticamente en el servidor sin necesidad de salir de la página, el uso de Flash Player para la visualización de los recursos educativos de tipo video en formato.flv para el correcto funcionamiento en los diferentes browser que hay en la actualidad, el uso de Google Docs para la visualización de los recursos educativos que están en formato office, HTML5 para ocupar los formatos en imagen y audio de los recursos.
...
> Este documento describe un sistema de recomendación basado en agentes adaptativos, actualmente en desarrollo, que integra la personalizacion de las recomendaciones al usuario a la vez que la estrategia comercial del sitio. El sistema de recomendación implementa una arquitectura propia de comercio electrónico denominada e-CoUSAL, pero perfectamente trasladable a cualquier sector de oferta de servicios en Internet.

>Recomendación influenciada como soporte al sistema de marketing. El sistema publicitario que acompaña al contenido de la página completa será igualmente personalizado. Los sistemas de marketing establecen como presentar la publicidad de cada producto destinada a segmentos de consumidores.

Conclusion
> Los procesos de decisión de un usuario en la red se complican debido a la gran cantidad de información que éste ha de manejar antes de la petición de un servicio y/o producto. La meta actual en las tecnologías de soporte a la decisión en red, es la introducción de las nuevas tecnologías como un paso natural del negocio tradicional. 


## [Evaluating ChatGPT as a Recommender System: A Rigorous Approach](https://arxiv.org/pdf/2309.03613.pdf)

> ChatGPT resuelve la tarea de recomendación con notable precisión. Incluso en su versión básica, sin aplicar técnicas para mejorar su rendimiento, ChatGPT alcanza resultados comparables con los RS de última generación y se distingue de otros LLM. De esta manera, nuestros resultados empíricos abren nuevas vías de pensamiento y sugieren que los LLM "orientados al usuario" como ChatGPT tienen el potencial de revolucionar el escenario de recomendación.

>Este estudio profundiza en el potencial de ChatGPT como sistema de recomendación, realizando una extensa investigación experimental en tres conjuntos de datos: MovieLens Small, Last.FM y Facebook Book. Comparamos el rendimiento de ChatGPT con varios sistemas de recomendación (RS) de última generación, como UserKNN, ItemKNN, RP3 β, EASER, AttributeItemKNN, AttributeUserKNN y VSM.

> También estábamos interesados en examinar cómo ChatGPT aprovecha los perfiles de usuario para reclasificar las recomendaciones existentes. Analizamos dos configuraciones: la primera con una lista fija de los elementos más populares y la segunda basada en los vecinos más cercanos del usuario. Los hallazgos demostraron la eficacia de ChatGPT para personalizar aún más las recomendaciones basadas en perfiles de usuario.

> En resumen, nuestros hallazgos revelaron que ChatGPT exhibía características de un sistema de recomendación híbrido, que aprovechaba la información colaborativa y basada en contenido. Además, ChatGPT mostró conocimientos de dominios específicos, particularmente en los dominios de libros y películas. Además, tendía a recomendar artículos populares y exhibía una notable habilidad en el manejo del problema del arranque en frío.

> Por último, la exploración de recomendaciones en escenarios con abundante información del usuario no fue factible debido a los límites de contexto de la API ChatGPT.
